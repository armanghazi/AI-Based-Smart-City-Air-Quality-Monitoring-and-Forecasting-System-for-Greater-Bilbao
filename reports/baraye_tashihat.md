...
python -c "import pandas as pd; df = pd.read_parquet('data/processed/air_quality_weather.parquet'); missing = df[df[['PM2.5','PM10','NO2','SO2']].isna().any(axis=1)]; print(missing[['Date', 'station', 'PM2.5', 'PM10', 'NO2', 'SO2']].sort_values('Date'))"
