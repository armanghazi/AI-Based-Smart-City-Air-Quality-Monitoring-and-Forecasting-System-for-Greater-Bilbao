...
if time_mode == "Day":
    ...
    # ── Weather snapshot for the selected day (reuses weather_panel component) ──
    weather_snapshot(df_filtered, show_per_station=False)
    ...
    if time_mode == "Year" and selected_year == "All":
        ...
        freq_col = "Day" if selected_month is not None else "Month"
