...
NAV = [
    ...
    {"icon": "💨", "title": "Weather Drivers",
     "desc": "Wind transport analysis · dispersion effects · seasonal patterns",
     "page": "pages/4_Weather_Drivers.py"},          # renamed file
    {"icon": "🔮", "title": "Forecast Explorer",
     "desc": "Next-day XGBoost predictions with SHAP",
    ...
    {"icon": "📖", "title": "Methodology",
     "desc": "Coverage, model accuracy, known gaps",
